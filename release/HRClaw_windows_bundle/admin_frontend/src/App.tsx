...
import { TrialHubPage } from "@/pages/TrialHubPage";
...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/" element={<Navigate to={bootstrap.username ? "/hr/trial" : "/login"} replace />} />
      <Route path="/login" element={<LoginPage />} />
      <Route path="/hr/trial" element={<TrialHubPage />} />
