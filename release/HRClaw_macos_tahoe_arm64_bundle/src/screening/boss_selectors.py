...
class BossSelectors:
    ...
    recommend_detail_ready: tuple[str, ...] = (
        ...
        "[role='dialog'] .button-list",
        "[role='dialog'] .iboss-left",
        "[role='dialog'] .geek-resume-wrap",
        "[role='dialog'] .resume-content",
        "[role='dialog'] button:has-text('打招呼')",
        "[role='dialog'] button:has-text('立即沟通')",
        "[role='dialog'] button:has-text('立即开聊')",
    )
    ...
    recommend_greet_button: tuple[str, ...] = (
        ".resumeGreet button",
        ".resumeGreet .btn-greet",
        ".button-chat-wrap.resumeGreet",
        ".operate-side .btn-greet",
        ".operate-side .button-chat-wrap",
        ".operate-side .button-list button:has-text('打招呼')",
        ".operate-side .button-list button:has-text('立即沟通')",
        ".operate-side .button-list button:has-text('立即开聊')",
        ".button-chat-wrap.button-chat",
        ".button-chat-wrap",
        "button.btn-greet",
        ".button-list button:has-text('打招呼')",
        ".button-list button:has-text('立即沟通')",
        ".button-list button:has-text('立即开聊')",
        ".card-inner button:has-text('打招呼')",
        ".card-inner button:has-text('立即沟通')",
        ".card-inner button:has-text('立即开聊')",
        "button:has-text('打招呼')",
