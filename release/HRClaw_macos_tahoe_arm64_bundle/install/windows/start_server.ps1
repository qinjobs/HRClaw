...
function Ensure-ChromeCdp {
  ...
  Write-Stage "resolved Chrome executable: $chromeExe"
  Write-Stage "Chrome profile dir: $ProfileDir"
  Write-Stage "Chrome start url: $StartUrl"
...
Ensure-ChromeCdp -Port $chromeCdpPort -ProfileDir $chromeProfileDir -BundledChromeExe $bundledChromeExe -StartUrl $chromeStartUrl
