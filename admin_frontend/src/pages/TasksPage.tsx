          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              <div className="space-y-2">
                <Label htmlFor="jobId">JD评分卡</Label>
                <NativeSelect
                  id="jobId"
                  value={jobId}
              ...
              <div className="space-y-2">
                <Label htmlFor="maxCandidates">最大人数</Label>
                <Input
                  id="maxCandidates"
                  type="number"
                  min="1"
              ...
              <div className="space-y-2">
                <Label htmlFor="maxPages">最大分页</Label>
                <Input
                  id="maxPages"
                  type="number"
                  min="1"
              ...
              <div className="space-y-2">
                ...
                <NativeSelect id="sortBy" value={sortBy} onChange={(event) => setSortBy(event.target.value)}>
